...
const Hero = () => {
  return (
    <section className="px-5 py-4 lg:py-24 mt-10 flex flex-col lg:flex-row items-center justify-between lg:mx-40 lg:px-1 max-w-xl md:max-w-xl mx-auto lg:max-w-7xl">
      <div
        id="hero-details"
        className="container order-2 lg:order-1 text-center lg:text-left mx-auto lg:px-6 pt-5 sm:pt-10 lg:pt-5 pb-20 lg:pb-5 lg:px-0 xl:mr-1 w-full lg:w-1/2"
      >

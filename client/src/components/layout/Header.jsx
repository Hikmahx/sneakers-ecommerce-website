...
const Header = () => {
  ...
  return (
    <header className="sm:px-3 lg:px-0 mx-auto">
      <div className="wrapper max-w-xl lg:max-w-7xl relative flex h-16 px-5 py-4 items-center justify-between lg:h-28 lg:mx-20 xl:mx-28 2xl:mx-40 lg:pb-2 lg:px-1 xl:px-3 2xl:px-1 lg:py-0 lg:border-b border-grayish-blue">

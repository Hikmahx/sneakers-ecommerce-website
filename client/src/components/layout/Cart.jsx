...
const Cart = () => {
//   const { cartItems, productTitleRef, total, deleteItem } =
//     useContext(ProductContext);
  ...
  return (
    <div className="absolute top-20 lg:top-24 bottom-40 inset-x-2 lg:left-auto lg:-right-16 lg:-mr-2 p-5 max-w-xl lg:max-w-sm lg:w-full mx-auto min-h-xs flex flex-col bg-white z-20 shadow-lg lg:shadow-xl rounded-lg">
